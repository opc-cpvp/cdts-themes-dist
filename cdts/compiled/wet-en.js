...
wet.builder.top = function(opt_data, opt_ignored) {
  ...
  if (opt_data.lngLinks != null) {
    ...
    var linkList62 = opt_data.lngLinks;
    var linkListLen62 = linkList62.length;
    for (var linkIndex62 = 0; linkIndex62 < linkListLen62; linkIndex62++) {
      var linkData62 = linkList62[linkIndex62];
      output += '<li><a hreflang="' + soy.$$escapeHtml(linkData62.lang) + '" lang="' + soy.$$escapeHtml(linkData62.lang) + '" href="' + soy.$$escapeHtml(linkData62.href) + '">' + soy.$$escapeHtml(linkData62.text) + '</a></li>';
    }
  ...
  if (opt_data.breadcrumbs != false) {
    ...
    if (opt_data.breadcrumbs != null) {
      var itemList101 = opt_data.breadcrumbs;
      var itemListLen101 = itemList101.length;
      for (var itemIndex101 = 0; itemIndex101 < itemListLen101; itemIndex101++) {
        var itemData101 = itemList101[itemIndex101];
        output += '<li>' + ((itemData101.acronym != null) ? '<abbr title="' + soy.$$escapeHtml(itemData101.acronym) + '">' : '') + ((itemData101.href != null) ? '<a href="' + soy.$$escapeHtml(itemData101.href) + '">' : '') + soy.$$escapeHtml(itemData101.title) + ((itemData101.href != null) ? '</a>' : '') + ((itemData101.acronym != null) ? '</abbr>' : '') + '</li>';
      }
    } else {
    ...
    if (opt_data.showFeedback != false || opt_data.showShare != false) {
      ...
      if (opt_data.showShare != false) {
        if (opt_data.showShare != null) {
          ...
          var itemList171 = opt_data.showShare;
          var itemListLen171 = itemList171.length;
          for (var itemIndex171 = 0; itemIndex171 < itemListLen171; itemIndex171++) {
            var itemData171 = itemList171[itemIndex171];
            output += '"' + soy.$$escapeHtml(itemData171) + '"' + ((! (itemIndex171 == itemListLen171 - 1)) ? ', ' : '');
          }
...
wet.builder.secmenu = function(opt_data, opt_ignored) {
  ...
  var sectionList217 = opt_data.sections;
  var sectionListLen217 = sectionList217.length;
  for (var sectionIndex217 = 0; sectionIndex217 < sectionListLen217; sectionIndex217++) {
    var sectionData217 = sectionList217[sectionIndex217];
    output += '<section class="list-group menu list-unstyled"><h3>' + ((sectionData217.sectionLink != null) ? '<a href="' + soy.$$escapeHtml(sectionData217.sectionLink) + '"' + ((sectionData217.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' : '') + soy.$$escapeHtml(sectionData217.sectionName) + ((sectionData217.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + ((sectionData217.sectionLink != null) ? '</a>' : '') + '</h3><ul class="list-group menu list-unstyled">';
    var linkList236 = sectionData217.menuLinks;
    var linkListLen236 = linkList236.length;
    for (var linkIndex236 = 0; linkIndex236 < linkListLen236; linkIndex236++) {
      var linkData236 = linkList236[linkIndex236];
      if (linkData236.subLinks != null) {
        output += '<li><a href="' + soy.$$escapeHtml(linkData236.href) + '" class="list-group-item"' + ((linkData236.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData236.text) + ((linkData236.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a><ul class="list-group menu list-unstyled">';
        var sublinkList251 = linkData236.subLinks;
        var sublinkListLen251 = sublinkList251.length;
        for (var sublinkIndex251 = 0; sublinkIndex251 < sublinkListLen251; sublinkIndex251++) {
          var sublinkData251 = sublinkList251[sublinkIndex251];
          output += '<li><a href="' + soy.$$escapeHtml(sublinkData251.subhref) + '" class="list-group-item"' + ((sublinkData251.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(sublinkData251.subtext) + ((sublinkData251.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
        }
        output += '</ul></li>';
      } else {
        output += '<li><a href="' + soy.$$escapeHtml(linkData236.href) + '" class="list-group-item"' + ((linkData236.newWindow == true) ? ' target="_blank"  rel="noopener"' : '') + '>' + soy.$$escapeHtml(linkData236.text) + ((linkData236.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>';
      }
    }
    output += '</ul></section>';
  }
...
wet.builder.footer = function(opt_data, opt_ignored) {
  ...
  if (opt_data.showFooter != false) {
    ...
    if (opt_data.contactLinks != null) {
      ...
      var linkList290 = opt_data.contactLinks;
      var linkListLen290 = linkList290.length;
      for (var linkIndex290 = 0; linkIndex290 < linkListLen290; linkIndex290++) {
        var linkData290 = linkList290[linkIndex290];
        output += (linkIndex290 == 0) ? '<li><a href="' + soy.$$escapeHtml(linkData290.href) + '">Contact us</a></li>' : '';
      }
      output += '</ul>';
    } else {
    ...
    if (opt_data.contactLinks != null) {
      var linkList305 = opt_data.contactLinks;
      var linkListLen305 = linkList305.length;
      for (var linkIndex305 = 0; linkIndex305 < linkListLen305; linkIndex305++) {
        var linkData305 = linkList305[linkIndex305];
        output += (linkIndex305 == 0) ? '<li><a ' + ((linkData305.href) ? ' href="' + soy.$$escapeHtml(linkData305.href) + '"' : ' href="https://priv.gc.ca/en/contact-the-opc/"') + ((linkData305.newWindow) ? ' target="_blank"  rel="noopener"' : '') + '>Contact information' + ((linkData305.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>' : '';
      }
    } else {
      output += '<li><a href="https://priv.gc.ca/en/contact-the-opc/">Contact information</a></li>';
    }
    if (opt_data.termsLink != null) {
      var linkList329 = opt_data.termsLink;
      var linkListLen329 = linkList329.length;
      for (var linkIndex329 = 0; linkIndex329 < linkListLen329; linkIndex329++) {
        var linkData329 = linkList329[linkIndex329];
        output += (linkIndex329 == 0) ? '<li><a ' + ((linkData329.href) ? ' href="' + soy.$$escapeHtml(linkData329.href) + '"' : ' href="https://priv.gc.ca/en/privacy-and-transparency-at-the-opc/terms-and-conditions-of-use/"') + ((linkData329.newWindow) ? ' target="_blank"  rel="noopener"' : '') + '>Terms and conditions' + ((linkData329.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>' : '';
      }
    } else {
    ...
    if (opt_data.privacyLink != null) {
      var linkList353 = opt_data.privacyLink;
      ...
      for (var linkIndex353 = 0; linkIndex353 < linkListLen353; linkIndex353++) {
        ...
        output += (linkIndex353 == 0) ? '<li><a ' + ((linkData353.href) ? ' href="' + soy.$$escapeHtml(linkData353.href) + '"' : ' href="https://priv.gc.ca/en/privacy-and-transparency-at-the-opc/pp/"') + ((linkData353.newWindow) ? ' target="_blank"  rel="noopener"' : '') + '>Privacy' + ((linkData353.newWindow == true) ? '<span class="wb-inv"> This link will open in a new window</span>' : '') + '</a></li>' : '';
      }
    } else {
