  ...
  if (opt_data.showFooter != false) {
    ...
    if (opt_data.contactLinks != null) {
      ...
      for (var linkIndex348 = 0; linkIndex348 < linkListLen348; linkIndex348++) {
        ...
        output += (linkIndex348 == 0) ? '<li><a href="' + soy.$$escapeHtml(linkData348.href) + '">Contactez-nous</a></li>' : '';
      }
      output += '</ul>';
    } else {
